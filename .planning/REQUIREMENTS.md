# Requirements: Foottfall Marketing Website
...
| Feature | Reason |
|---------|--------|
| User Auth | Not required for public marketing site. |
| Inventory CMS | Separate product (Inventory PWA). |
| Real-time Data | Map data is compiled at build-time. |
